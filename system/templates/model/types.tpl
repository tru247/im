...
<head>
    ...
    <title>Les Aubaines - Types of models</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Types of Models</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><span>Types of models</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                    ...
                    <div class="panel panel-default card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <a class="btn btn-success" href="/model/new-type"><i class="fa fauser-plus"></i> New Model Type</a>
                                <hr>
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="model-types" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>Title</th>
                                                <th>Description</th>
                                            ...
                                            {foreach $types as $type}
                                                <tr>
                                                    <td>{$type.title}</td>
                                                    <td>{$type.description|default:'N/A'}</td>
                                                    <td><!--a class="label label-primary" href="/model/profile/{$model.url}">Edit</a |--> <a href='/model/delete-type/{$type.id}' class="label label-danger">Delete</a></td>
                                                </tr>
                                            {/foreach}
                                            </tbody>
                                        </table>
