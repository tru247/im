...
<head>
    ...
    <title>Kimsape - System Adminitrators</title>
            ...
            <div class="row heading-bg">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#"><span>Kimsape</span></a></li>
                            ...
                            <div class="panel-body">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="clients" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Ref. Id</th>
                                            ...
                                            {foreach $users as $client}
                                                <tr>
                                                    ...
                                                    <td><a href="{$globals.client.profile|cat:($client.url)}">View</a></td>
                                                </tr>
                                            {/foreach}
                                            </tbody>
                                        </table>
