...
<div class="wrapper theme-1-active pimary-color-red">
    ...
    <div class="page-wrapper">
        <div class="container">
            <div class="col-sm-12">
                <div class="form-area">  
                    <form class="form-horizontal" action="/event/add" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <br style="clear:both">
                        <h3 style="margin-bottom: 25px; text-align: center;">New Event</h3>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="" class="control-label">Event Photo</label>
