        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark"><i class="fa fa-calendar"></i> Events</h5>
                </div>
                <!-- Breadcrumb -->
                                        ...
                                        <table id="sysadmins" class="table table-hover display  pb-30" >
                                            ...
                                            <tbody>
                                                {foreach $events as $event}
                                                    <tr>
                                                        <td>{$event.title}</td>
                                                        <td>{$event.excerpt|truncate:45}</td>
                                                        <td>{$event.created_at}</td>
                                                        <td><a href="{$globals.blog.profile|cat:($event.url)}">View</a></td>
                                                    <td><a class="label label-primary" href="/event/profile/{$event.url}">Edit</a> | <a href='/event/delete/{$event.id}' class="label label-danger">Delete</a></td>
                                                    </tr>
                                                {/foreach}
                                            </tbody>
                                        </table>
