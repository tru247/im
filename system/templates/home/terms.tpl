				...
				<div class="row">
					<div class="col-md-12">
						<div class="term-conditions">
							<div class="text-wrap">
							    <h1 style="text-align: center;">TERMS OF SERVICE</h1><hr>
								<h3>OVERVIEW</h3>
								<p>
									This website is operated by Zoe Beauty World. Throughout the site, the terms “we”, “us” and “our” refer to Zoe Beauty World. Zoe Beauty World offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
								</p>
								<p>
							...
							<div class="text-wrap">
							    ...
							    <p>
							        These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Republic of Kenya.
							    </p>
							</div>
							<div class="text-wrap">
							...
							<div class="text-wrap">
							    ...
							    <p>
							        Questions about the Terms of Service should be sent to us at <a href="mailto:info@zoebeautyworld.co.ke">info@zoebeautyworld.co.ke</a>
							    </p>
							</div>
						</div><!-- /.term-conditions -->
					</div><!-- /.col-md-12 -->
