        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <h5 style="" class="txt-dark"><i class="fa fa-tachometer"></i><strong style="color: #3ab54a;"> {$app.name}</strong> Shop Manager(s)</h5>
                </div>
                <!-- Breadcrumb -->
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="/dashboard">Dashboard</a></li>
                        <li class="active"><span>Shop Manager(s)</span></li>
                    </ol>
                </div>
                <!-- /Breadcrumb -->
            </div>
                            ...
                            <div class="panel-body">
                                <div class="table-wrap">
                                    <div class="table-responsive">
                                        <table id="admins" class="table table-hover display  pb-30" >
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Position</th>
