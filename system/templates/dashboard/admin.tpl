                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                <i style="color:#ffffff;" class="fa fa-4x fa-users"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body pa-0">
                                <div class="sm-data-box bg-blue">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <span class="txt-light block counter"><span class="counter-anim">{$models|default: '0'}</span></span>
                                                <span class="weight-500 uppercase-font txt-light block">Model(s)</span>
                                            </div>
                                            <div class="col-xs-6 text-center  pl-0 pr-0 pt-25  data-wrap-right">
                                                <i style="color:#ffffff;" class="fa fa-4x fa-star"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body pa-0">
                                <div class="sm-data-box bg-yellow">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <span class="txt-light block counter"><span class="counter-anim">{$events|default: '0'}</span></span>
                                                <span class="weight-500 uppercase-font txt-light block">Event(s)</span>
                                            </div>
                                            <div class="col-xs-6 text-center  pl-0 pr-0 pt-25  data-wrap-right">
                                                <i style="color:#ffffff;" class="fa fa-4x fa-calendar"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body pa-0">
                                <div class="sm-data-box bg-red">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                <span class="txt-light block counter"><span class="counter-anim">{$blogs|default: '0'}</span></span>
                                                <span class="weight-500 uppercase-font txt-light block">Blog(s)</span>
                                            </div>
                                            <div class="col-xs-6 text-center  pl-0 pr-0 pt-25  data-wrap-right">
                                                <i style="color:#ffffff;" class="fa fa-4x fa-book"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
